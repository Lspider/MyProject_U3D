...
{    
    ...
    public static readonly string SERVER_RES_URL = "file:///D:/Res/";    
    ...
    private void Show()    
    {    
        var _obj = ResourceManager.Instance.LoadAsset<GameObject>("Prefabs\\Login");
        if (_obj) {
            var _instance = Instantiate(_obj);
        } 
    }    
