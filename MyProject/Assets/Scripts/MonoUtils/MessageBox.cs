...
public class MessageBox : MonoBehaviour{
    ...
    public static void ShowAlertBox(string message, string title, Action onFinished = null)
    {
        ...
        if (alertPanel == null)
        {
            alertPanel = (Instantiate(Resources.Load("Prefabs/AlertBox")) as GameObject).transform;
    ...
    public  static void ShowConfirmBox(string message, string title, Action<bool> onFinished = null)
    {
        ...
        {
            confirmPanel = (Instantiate(Resources.Load("Prefabs/ConfirmBox")) as GameObject).transform;
